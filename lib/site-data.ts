...
export const faqs = [
  ...
  },
  {
    ...
    a: 'The tool is designed to scan Bitcoin and a wide universe of altcoins, surfacing both long and short setups with key levels.',
  },
  {
    q: 'How do I get access?',
    a: 'Access is gated through checkout. Click any "ACCESS NOW" button to lock in the current discounted price and unlock the member portal.',
  },
  {
    q: 'How long is the 50% discount available?',
    a: 'The discount is limited-time. Use the countdown on the pricing section as a guide and secure access while the offer window is open.',
  },
  {
    q: 'Where do I see the portal?',
    a: 'Once you complete checkout, you get instant access to the one-page dashboard where signals and on-demand analysis live.',
  },
]

export const features = [
  {
    title: 'Real-time Long & Short Signals',
    body: 'Entry ideas presented cleanly with key levels, so you know what to watch and where.',
  },
  {
    title: 'Analysis & Reasoning',
    body: 'Not just a call — you get the logic behind the idea (zones, acceptance, liquidity context).',
  },
  {
    title: 'Stop-Loss Placement Ideas',
    body: 'Adaptive stop-loss suggestions designed to help manage downside and avoid random guessing.',
  },
  {
    title: 'Fast, One-Page Dashboard',
    body: 'Clear signals and on demand analysis at your finger tips.',
  },
  {
    title: 'BTC + Altcoins',
    body: 'Scan across majors and alts — the tool is designed to handle BTC and a wide altcoin universe.',
  },
  {
    title: 'Members-Only Access',
    body: 'Access is gated through checkout. Click "ACCESS NOW" to lock in the discounted price.',
  },
]
